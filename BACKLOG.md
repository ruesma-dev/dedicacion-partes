...
| F-003 | Las columnas sigrid_* de asignacion no están en el ORM | 3 | spec lista | critico | `feature/F-003-orm-columnas-sigrid` |
...
estado **spec lista** · prioridad 3 · rigor `critico` · SDD sí · rama `feature/F-003-orm-columnas-sigrid`
