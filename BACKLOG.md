...
| F-008 | Infraestructura y despliegue en Azure | 3 | spec lista | critico | `feature/F-008-infra-azure` |
...
estado **spec lista** · prioridad 3 · rigor `critico` · SDD sí · rama `feature/F-008-infra-azure`
