...
| F-011 | Un solo codigo de hora mes por trabajador | 8 | pendiente | estandar | `feature/F-011-codigo-hora-mes-unico` |
| F-012 | El test de la epsilon compartida ata el transfer al monorepo | 9 | pendiente | estandar | `feature/F-012-epsilon-compartida-entre-servicios` |
...
estado **pendiente** · prioridad 4 · rigor `critico` · SDD no · rama `feature/F-013-linea-sin-partida-confirma`
...
estado **pendiente** · prioridad 6 · rigor `estandar` · SDD sí · rama `feature/F-005-nomenclatura-dedicacion`
...
estado **pendiente** · prioridad 7 · rigor `estandar` · SDD no · rama `feature/F-006-sanear-suite-transfer`
...
estado **pendiente** · prioridad 8 · rigor `estandar` · SDD no · rama `feature/F-011-codigo-hora-mes-unico`
...
estado **pendiente** · prioridad 9 · rigor `estandar` · SDD no · rama `feature/F-012-epsilon-compartida-entre-servicios`
