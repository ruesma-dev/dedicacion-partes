...
- [x] T2 · HECHA: entrada añadida al catálogo, commiteada por el humano (`4d7cfa8`), pusheada y desplegada. Añadir la entrada de `catalog.js` en `front-portal` con ese GUID y
...
- [x] T4 · HECHA por el humano (2026-08-21): 8 miembros en el grupo, verificado con az: Dar de alta a esas personas con
      ...
      los lista.
- [x] T5 · HECHA por el humano (2026-08-21): confirma que la tarjeta aparece y el acceso funciona. Ventana de incógnito: un miembro entra al front y ve el cuadrante;
